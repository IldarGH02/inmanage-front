...
import { editTransport } from "../../../../../app/store/actions/assets/assetsActions";
        ...
        <Formik
            ...
            onSubmit={values => {
                ...
                if(errorDropList.brandType==='' && errorDropList.modelType==='' && errorDropList.ownerType==='' && errorDropList.yearType==='') {
                    const transportTmp: IAssetsTransport = {
                        id: transport.id,
                        mark: brandType,
                        model: modelType,
                        bought_price: Number(values.sum.replace(/ /g, '')), //цена покупки
                        revenue: transport.revenue, //доход
                        month_income: transport.month_income,
                        month_expense: transport.month_expense,
                        average_profit: transport.average_profit,
                        ...
                        total_income: transport.total_income,
                        ...
                        month_payment: transport.month_payment, // ежемесячный платеж
                    ...
                    const res = editTransport(actionTypes.EDIT_TRANSPORT, transportTmp)
                    res.then(e => {
                        dispatch(e!);
                        navigate(`/assets/transport/${id}`)
                    })
                    .catch((e) => {
                        console.log(e)
                    })
        ...
        >
            ...
            <Form className="add-transport-form">
                ...
                <div className="add-transport-form__btns">
                    <Link to={`/assets/transport/${id}`} className="cancel-btn add-transport-form__cancel-btn">Отменить</Link>
