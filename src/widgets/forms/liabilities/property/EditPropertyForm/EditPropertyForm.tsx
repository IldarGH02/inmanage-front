...
import { editProperty, hideLoader } from "../../../../../app/store/actions/liabilities/liabilitiesActions";
...
export function EditPropertyForm({property}: IEditPropertyForm) {
    ...
    return (
        <Formik
            ...
            initialValues={
                {
                    ...
                    address: "",
                    owner: property!==null ? property.owner : '',//property.owner,
            ...
            onSubmit={values => {
                let newProperty: ILiabilitiesProperty = {
                    id: property?.id,
                    name: values.name,
                    // address: '',
                ...
                const res = editProperty(actionTypesLiabilities.EDIT_PROPERTY_LIABILITIES, newProperty)
                res.then(e => {
                    dispatch(e!);
                    navigate(`/liabilities/property/${id}`)
                })
                .catch((e) => {
        ...
        >
            ...
            <Form className="edit-property-form">
                        ...
                        <div className="add-business-form__about-card-block">
                            ...
                            <>
                                ...
                                <div className="edit-property-form__item">
                                    ...
                                    />
                                    <ErrorMessage name="date" render={msg => <div className="edit-property-form__warning">{msg}</div>} />
                                </div>
                                <div className="edit-property-form__item">
                                    <InputSumForm
                                        valuta="мес." 
                                    ...
                                    />
                                    <ErrorMessage name="loanTerms" render={msg => <div className="edit-property-form__warning">{msg}</div>} />
                                </div>
                                <div className="edit-property-form__item">
                                    <InputPercentForm
                            ...
                            <div className="edit-property-form__item">
                                <InputSumForm
                                    ...
                                    background="rgb(241, 242, 246)"    
                                />
                                <ErrorMessage name="rentSum" render={msg => <div className="edit-property-form__warning">{msg}</div>} />
                            </div>
                ...
                <div className="edit-property-form__btns">
                    ...
                    <button className="edit-property-form__add-btn" type="submit" onClick={()=>console.log(values)}>Подтвердить</button>
                </div>
            </Form>
       )}
        </Formik>
