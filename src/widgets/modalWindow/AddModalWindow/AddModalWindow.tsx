...
import { steps } from "../steps/data/assetsPropertyData";
...
interface IAddModal {
    onAddPropertyItem: (el:IAssetsProperty)=>void
}
...
export function AddModal({onAddPropertyItem}:IAddModal) {
    ...
    const { dataArr, stepsArr, nextStep, earlierStep, clearSteps } = useContext(AddModalContext) as IModalContext
