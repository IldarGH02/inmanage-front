...
// export function AssetsAutoInfo() {
...
//         setModelSelector('toyota') //dataArr.name
//         setBrandSelector('sas') //dataArr.brand
//     },[])
...
//                             <p>{modelSelector === '' ?  'Выберете модель транспорта' : modelSelector}</p> 
//                         </label> 
//                         <div className="drop-down-list__content">
