...
import { usePropertyInventory } from "../../../../../features/hooks/assets/property/propertyInventoryHooks";
...
export function InventoryModalWindow({id}: IInventoryModalWindow) {
    ...
    const {newData, addInventory, changeInventoryAll, removeInventory, getInventory, count, generalPrice} = usePropertyInventory()
        ...
        <div className="inventory-modal">
            ...
            <div className="inventory-modal__content">
                ...
                <div className="inventory-modal__list">
                    ...
                    {newData.map((item: IInventoryProperty) => {
                        return (
