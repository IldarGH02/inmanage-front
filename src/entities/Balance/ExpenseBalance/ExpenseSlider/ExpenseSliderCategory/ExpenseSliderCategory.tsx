...
//     //         switch (id) {
//     //             case 1: {
//     //                 arr = stateAssets.actives!.properties!.properties.map(el=>{
//     //                     return {
//     //                         id: el.id!,
//     //                         name: el.name,
//     //                         img: loans
...
//     //             case 2: {
//     //                 arr = stateAssets.actives!.transports!.transport.map(el=>{
//     //                     return {
//     //                         id: el.id!,
...
//     //             case 3: {
//     //                 arr = stateAssets.actives!.businesses!.businesses.map(el=>{
//     //                     return {
//     //                         id: el.id!,
//     //                         name: el.name,
//     //                         img: loans
